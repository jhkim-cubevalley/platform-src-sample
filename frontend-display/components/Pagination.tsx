  ...
  return (
    <button
      ...
      className={cls(
        ...
        `flex h-10 w-10 items-center justify-center rounded-[28px] border border-[#D9D9D9]`
      )}
    >
      <div className="h-10 w-10 text-center align-middle text-lg font-[350] leading-10 ">
        {pageIndex}
      </div>
    </button>
  );
